## Asociación total consultas, temperatura Hospital San Juan de Dios - Santiago##
...
rm(HConce, HLCM, HRRIO, HSere, PCentral, HSJ)
...
#Si se asigna NA se pierden 1 datos entre 2014-2018, esa puede ser la razón por la baja en 2014,
...
pdf("Fig/STConsultasTemp_HSJD.pdf")
par(mex=0.8,mfrow=c(2,1))
# Consultas
plot(data$fecha2, data$Col01, type="l", col= "black", ylab="N°consultas", xlab="Fecha", main="Número de Consultas 2009-2018 HSJD-Santiago")
# Temperatura
...
summary(model3d)
pred3d <- predict(model3c, type="response")
...
pdf("Fig/ConsultasyTempLineal_HSJD.pdf")
