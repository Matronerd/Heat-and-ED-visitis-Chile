## Asociación total consultas, temperatura Hospital San José - Santiago##
...
# Consultas
plot(data$fecha2, data$Col01, type="l", col= "black", ylab="N°consultas", xlab="Fecha", main="Número de Consultas 2009-2018 HSJ-Santiago")
# Temperatura
plot(data$fecha2, data$t_mean, type="l", col= "red4", ylab="Temperatura (ºC)", xlab="Fecha", main="Temperatura (°C) 2009-2018, Santiago")
dev.off()
...
# Revisar parámetro de sobredispersión (5,6)
...
# Model with 8 sine-cosine pairs. (Parametro de dispersión = 4,8)
