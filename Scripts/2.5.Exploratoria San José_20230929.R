...
causa1<- serie("1", "San José - Total causas")
causa2<- serie("2", "San José - Respiratorias")
causa3<- serie("12", "San José - Circulatorias")
causa4<- serie("18", "San José - Traumatismos y envenenamiento")
causa5<- serie("21", "San José - Otras causas")
