## Asociación total consultas, temperatura Hospital San Juan de Dios - La Serena ##
...
which(data$Col01<1)
#data$Col01<-ifelse(data$Col01<1, NA , data$Col01) transformaría en NA 125 datos
...
# Consultas
plot(data$fecha2, data$Col01, type="l", col= "black", ylab="N°consultas", xlab="Fecha", main="Número de Consultas 2009-2018 HSJD-La Serena")
# Temperatura
plot(data$fecha2, data$t_mean, type="l", col= "red3", ylab="Temperatura (ºC)", xlab="Fecha", main="Temperatura (°C) 2009-2018, La Serena")
dev.off()
